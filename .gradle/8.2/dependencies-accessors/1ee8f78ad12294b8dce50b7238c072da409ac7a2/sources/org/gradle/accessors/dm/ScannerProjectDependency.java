...
public class ScannerProjectDependency extends DelegatingProjectDependency {
    ...
    /**
     * Creates a project dependency on the project at path ":scanner:devices"
     */
    public Scanner_DevicesProjectDependency getDevices() { return new Scanner_DevicesProjectDependency(getFactory(), create(":scanner:devices")); }
