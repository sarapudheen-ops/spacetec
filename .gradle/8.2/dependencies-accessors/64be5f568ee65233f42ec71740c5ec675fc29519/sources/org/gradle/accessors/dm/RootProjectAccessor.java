...
public class RootProjectAccessor extends TypeSafeProjectDependencyFactory {
     ...
     */
    public SpaceTecProjectDependency getSpaceTec() { return new SpaceTecProjectDependency(getFactory(), create(":")); }
    ...
    /**
     * Creates a project dependency on the project at path ":transport"
     */
    public TransportProjectDependency getTransport() { return new TransportProjectDependency(getFactory(), create(":transport")); }
