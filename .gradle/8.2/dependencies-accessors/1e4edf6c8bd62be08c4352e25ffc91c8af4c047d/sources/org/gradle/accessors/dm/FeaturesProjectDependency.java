...
public class FeaturesProjectDependency extends DelegatingProjectDependency {
    ...
    /**
     * Creates a project dependency on the project at path ":features:vehicle"
     */
    public Features_VehicleProjectDependency getVehicle() { return new Features_VehicleProjectDependency(getFactory(), create(":features:vehicle")); }
